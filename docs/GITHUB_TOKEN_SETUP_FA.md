...
با مجوزهای کامل، می‌توانید با سرورهای MCP گیت‌هاب تعامل کنید:

```bash
# مثال: پرس و جو داده‌های گیت‌هاب از طریق MCP
curl -H "Authorization: Bearer YOUR_TOKEN" \
     https://api.github.com/repos/owner/repo/contents/

# استفاده با عوامل هوش مصنوعی و ابزارها
# توکن به عوامل امکان دسترسی به منابع گیت‌هاب را می‌دهد
```
